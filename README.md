...
| Architecture | Test Accuracy | Test F1 | Notes |
|--------------|--------------|--------|-------|
| TinyCNN      | 0.514        | 0.486  | baseline |
| DeeperCNN    | 0.670        | 0.662  | best baseline |
| SmallResNet  | 0.598        | 0.514  | overfits without reg |
...
| Weighted loss (inv-freq)   | 0.640    | 0.617    | — |
| Weighted sampler           | 0.681    | 0.677    | 72.7% |
...
| Run / Config | Accuracy | Macro-F1 | Disgust Recall |
|--------------|----------|----------|----------------|
| A TinyCNN (no reg)        | 0.514 | 0.486 | 34.5% |
| A TinyCNN (regularized)    | 0.529 | 0.454 | 16.4% |
| B DeeperCNN (baseline)     | 0.670 | 0.662 | 70.9% |
| C SmallResNet (baseline)   | 0.598 | 0.514 | 10.9% |
| C SmallResNet (regularized)| 0.656 | 0.621 | 58.2% |
| C tuned SmallResNet        | 0.677 | 0.647 | — |
| C weighted loss            | 0.640 | 0.617 | — |
| C weighted sampler         | 0.681 | 0.677 | 72.7% |
